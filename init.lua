...
vim.keymap.set('n', '<leader>e', function()
  ...
  if current_buf:match 'neo%-tree' then
    -- If currently in Neo-tree, go back to previous window
    vim.cmd 'wincmd p'
  else
    -- Focus Neo-tree (open it if needed)
...
require('lazy').setup({ -- NOTE: Plugins can be added with a link (or for a github repo: 'owner/repo' link).
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    dependencies = {
      ...
      { 'nvim-telescope/telescope-ui-select.nvim' }, -- vim.g.have_nerd_font = true
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sa', function()
        ...
        desc = '[S]earch [A]ll files from root',
      })
